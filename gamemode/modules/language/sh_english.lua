...
local english = {
	...
	customer_no_suicide = "You can't place a hit on yourself."
	hitman_no_self_order = "A hitman cannot order a hit for himself.",
	hitman_on_hitman_order = "You can't order a hitman to hit another hitman.",
...
DarkRP.addLanguage("en", english) -- Make sure "en" is a valid entry for the convar gmod_language.
