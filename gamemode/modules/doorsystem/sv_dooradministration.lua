...
local function ccLock(ply, cmd, args)
	...
	MySQLite.query("REPLACE INTO darkrp_door VALUES("..MySQLite.SQLStr(trace.Entity:EntIndex())..", "..MySQLite.SQLStr(string.lower(game.GetMap()))..", "..MySQLite.SQLStr(trace.Entity:getKeysTitle() or "")..", 1, "..(trace.Entity:getKeysNonOwnable() and 1 or 0)..");")
...
local function ccUnLock(ply, cmd, args)
	...
	MySQLite.query("REPLACE INTO darkrp_door VALUES("..MySQLite.SQLStr(trace.Entity:EntIndex())..", "..MySQLite.SQLStr(string.lower(game.GetMap()))..", "..MySQLite.SQLStr(trace.Entity:getKeysTitle() or "")..", 0, "..(trace.Entity:getKeysNonOwnable() and 1 or 0)..");")
