...
local function drawChatReceivers()
    ...
    draw.WordBox(2, x, y - (receiversCount * 24), DarkRP.getPhrase("hear_certain_persons", currentConfig.text), "DarkRPHUD1", Color(0,0,0,160), Color(0,255,0,255))
    for i = 1, receiversCount, 1 do
        ...
        draw.WordBox(2, x, y - (i - 1) * 24, receivers[i]:Nick(), "DarkRPHUD1", Color(0, 0, 0, 160), color_white)
    end
end
