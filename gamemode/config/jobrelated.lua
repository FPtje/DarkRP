...
TEAM_POLICE = DarkRP.createJob("Полицейский", {
    ...
    model = {"models/player/kerry/policeru_01_patrol.mdl", "models/player/kerry/police_02_female.mdl"},
    ...
    weapons = {"arrest_stick", "unarrest_stick", "m9k_amd65", "m9k_usp", "stunstick", "door_ram", "weaponchecker", "itemstore_pickup"},
    command = "cp",
    max = 4,
...
TEAM_GANG = DarkRP.createJob("Бандит", {
    ...
    weapons = {"m9k_acr", "itemstore_pickup"},
    command = "gangster",
    max = 6,
    salary = GAMEMODE.Config.normalsalary,
    admin = 0,
...
TEAM_MOB = DarkRP.createJob("Глава Бандитов", {
    ...
    weapons = {"lockpick", "unarrest_stick", "m9k_deagle", "m9k_ak74", "itemstore_pickup"},
    command = "mobboss",
    max = 3,
...
TEAM_CHIEF = DarkRP.createJob("Начальник полиции", {
    ...
    weapons = {"arrest_stick", "unarrest_stick", "m9k_m416", "m9k_m92beretta", "m9k_mossberg590", "stunstick", "door_ram", "weaponchecker", "itemstore_pickup"},
    command = "chief",
    max = 1,
