...
--------------------------------------------------------]]
TEAM_CITIZEN = DarkRP.createJob("Shithead", {
    ...
    description = [[FUCK FUCK FUCK FUCK FUCK WHY THE FUCK]],
    weapons = {},
    command = "citizen",
    max = 0,
...
TEAM_MEDIC = DarkRP.createJob("Rescue", {
    ...
    description = [[you can heal ppl lol
        u can also put out fires
        Lefsddsdthe Medical Kit to heal other players.
        Right clickggdgal Kit to heal yourself.]],
    weapons = {"med_kit"},
    command = "medic",
    max = 3,
    salary = GAMEMODE.Config.normalsalary,
...
DarkRP.createDemoteGroup("Criminals", {TEAM_GANG, TEAM_MOB})
