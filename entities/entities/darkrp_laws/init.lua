...
local function addLaw(ply, args)
	...
	if not canEdit then
		DarkRP.notify(ply, 1, 4, message ~= nil and message or DarkRP.getPhrase("incorrect_job", GAMEMODE.Config.chatCommandPrefix .. "addLaw"))
		return ""
	end
...
local function removeLaw(ply, args)
	...
	if not canEdit then
		DarkRP.notify(ply, 1, 4, message ~= nil and message or DarkRP.getPhrase("incorrect_job", GAMEMODE.Config.chatCommandPrefix .. "removeLaw"))
		return ""
	end
...
local function resetLaws(ply, args)
	...
	if not canEdit then
		DarkRP.notify(ply, 1, 4, message ~= nil and message or DarkRP.getPhrase("incorrect_job", GAMEMODE.Config.chatCommandPrefix .. "resetLaws"))
		return ""
	end
...
local function placeLaws(ply, args)
	...
	if not canEdit then
		DarkRP.notify(ply, 1, 4, message ~= nil and message or DarkRP.getPhrase("incorrect_job", GAMEMODE.Config.chatCommandPrefix .. "placeLaws"))
		return ""
	end
